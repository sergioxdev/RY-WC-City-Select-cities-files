...
return [
	'MV' => [
		...
		'DHAT' => __( 'Dhaalu Atholhu', 'ry-wc-city-select' ),
		'FAAT' => __( 'Faafu Atholhu', 'ry-wc-city-select' ),
		'GAALAT' => __( 'Gaafu Alifu Atholhu', 'ry-wc-city-select' ),
		'GADHAT' => __( 'Gaafu Dhaalu Atholhu', 'ry-wc-city-select' ),
		...
		'SHAT' => __( 'Shaviyani Atholhu', 'ry-wc-city-select' ),
		'SOARAT' => __( 'Southern Ari Atoll', 'ry-wc-city-select' ),
