...
return [
	...
	'CA' => [
		...
		_x('Arrondissement de Caen', 'CA', 'ry-wc-city-select'),
		_x('Arrondissement de Lisieux', 'CA', 'ry-wc-city-select'),
		_x('Arrondissement de Vire', 'CA', 'ry-wc-city-select'),
	],
	'CA2' => [
		_x('Arrondissement dAurillac', 'CA2', 'ry-wc-city-select'),
		_x('Arrondissement de Mauriac', 'CA2', 'ry-wc-city-select'),
		_x('Arrondissement de Saint-Flour', 'CA2', 'ry-wc-city-select'),
	],
	'CH' => [
		_x('Arrondissement dAngouleme', 'CH', 'ry-wc-city-select'),
		_x('Arrondissement de Cognac', 'CH', 'ry-wc-city-select'),
		_x('Arrondissement de Confolens', 'CH', 'ry-wc-city-select'),
	],
	'CH2' => [
		_x('Arrondissement de Jonzac', 'CH2', 'ry-wc-city-select'),
		_x('Arrondissement de La Rochelle', 'CH2', 'ry-wc-city-select'),
		_x('Arrondissement de Rochefort', 'CH2', 'ry-wc-city-select'),
		_x('Arrondissement de Saint-Jean-dAngely', 'CH2', 'ry-wc-city-select'),
		_x('Arrondissement de Saintes', 'CH2', 'ry-wc-city-select'),
	],
	'CH3' => [
		_x('Arrondissement de Bourges', 'CH3', 'ry-wc-city-select'),
	...
	'DO' => [
		...
		_x('Arrondissement de Nontron', 'DO', 'ry-wc-city-select'),
		_x('Arrondissement de Perigueux', 'DO', 'ry-wc-city-select'),
		_x('Arrondissement de Sarlat-la-Caneda', 'DO', 'ry-wc-city-select'),
	],
	'DO2' => [
	...
	'GA' => [
		...
		_x('Arrondissement de Nimes', 'GA', 'ry-wc-city-select'),
		_x('Arrondissement du Vigan', 'GA', 'ry-wc-city-select'),
	],
	'GE' => [
		_x('Arrondissement dAuch', 'GE', 'ry-wc-city-select'),
		_x('Arrondissement de Condom', 'GE', 'ry-wc-city-select'),
		_x('Arrondissement de Mirande', 'GE', 'ry-wc-city-select'),
	],
	'GI' => [
		_x('Arrondissement dArcachon', 'GI', 'ry-wc-city-select'),
		_x('Arrondissement de Blaye', 'GI', 'ry-wc-city-select'),
		_x('Arrondissement de Bordeaux', 'GI', 'ry-wc-city-select'),
		_x('Arrondissement de Langon', 'GI', 'ry-wc-city-select'),
		_x('Arrondissement de Lesparre-Medoc', 'GI', 'ry-wc-city-select'),
		_x('Arrondissement de Libourne', 'GI', 'ry-wc-city-select'),
	],
	'HA' => [
	...
	'HA5' => [
		...
		_x('Arrondissement de Bonneville', 'HA5', 'ry-wc-city-select'),
		_x('Arrondissement de Saint-Julien-en-Genevo', 'HA5', 'ry-wc-city-select'),
		_x('Arrondissement de Thonon-les-Bains', 'HA5', 'ry-wc-city-select'),
	],
	'HA6' => [
		_x('Arrondissement de Bellac', 'HA6', 'ry-wc-city-select'),
		_x('Arrondissement de Limoges', 'HA6', 'ry-wc-city-select'),
		_x('Arrondissement de Rochechouart', 'HA6', 'ry-wc-city-select'),
	],
	'HA7' => [
		_x('Arrondissement de Briancon', 'HA7', 'ry-wc-city-select'),
	...
	'JU' => [
		...
		_x('Arrondissement de Lons-le-Saunier', 'JU', 'ry-wc-city-select'),
		_x('Arrondissement de Saint-Claude', 'JU', 'ry-wc-city-select'),
	],
	'LA' => [
		_x('Arrondissement de Dax', 'LA', 'ry-wc-city-select'),
	...
	'MO' => [
		...
		_x('Arrondissement de Pontivy', 'MO', 'ry-wc-city-select'),
	...
	'NO' => [
		...
		_x('Arrondissement de Cambrai', 'NO', 'ry-wc-city-select'),
		_x('Arrondissement de Douai', 'NO', 'ry-wc-city-select'),
	...
	'PA2' => [
		_x('Arrondissement dArras', 'PA2', 'ry-wc-city-select'),
		_x('Arrondissement de Bethune', 'PA2', 'ry-wc-city-select'),
		_x('Arrondissement de Boulogne-sur-Mer', 'PA2', 'ry-wc-city-select'),
		_x('Arrondissement de Calais', 'PA2', 'ry-wc-city-select'),
		_x('Arrondissement de Lens', 'PA2', 'ry-wc-city-select'),
	...
	'SE' => [
		...
		_x('Arrondissement de Rouen', 'SE', 'ry-wc-city-select'),
		_x('Arrondissement du Havre', 'SE', 'ry-wc-city-select'),
	],
	'SE2' => [
		_x('Arrondissement de Bobigny', 'SE2', 'ry-wc-city-select'),
		_x('Arrondissement de Saint-Denis', 'SE2', 'ry-wc-city-select'),
		_x('Arrondissement du Raincy', 'SE2', 'ry-wc-city-select'),
	],
	'SE3' => [
		_x('Arrondissement de Fontainebleau', 'SE3', 'ry-wc-city-select'),
		_x('Arrondissement de Meaux', 'SE3', 'ry-wc-city-select'),
		_x('Arrondissement de Melun', 'SE3', 'ry-wc-city-select'),
		_x('Arrondissement de Provins', 'SE3', 'ry-wc-city-select'),
		_x('Arrondissement de Torcy', 'SE3', 'ry-wc-city-select'),
	],
	'SO' => [
		_x('Arrondissement dAbbeville', 'SO', 'ry-wc-city-select'),
		_x('Arrondissement dAmiens', 'SO', 'ry-wc-city-select'),
	...
	'VA' => [
		...
		_x('Arrondissement de LHay-les-Roses', 'VA', 'ry-wc-city-select'),
		_x('Arrondissement de Nogent-sur-Marne', 'VA', 'ry-wc-city-select'),
	],
	'VA2' => [
		_x('Arrondissement de Brignoles', 'VA2', 'ry-wc-city-select'),
	...
	'VI' => [
		...
		_x('Arrondissement de Poitiers', 'VI', 'ry-wc-city-select'),
	],
	'VO' => [
	...
	'YV' => [
		...
		_x('Arrondissement de Rambouillet', 'YV', 'ry-wc-city-select'),
		_x('Arrondissement de Saint-Germain-en-Laye', 'YV', 'ry-wc-city-select'),
		_x('Arrondissement de Versailles', 'YV', 'ry-wc-city-select'),
	],
	]
];